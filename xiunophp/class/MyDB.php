...
class MyDB
{
	...
	{
		if (empty($cond)):
			return self::rdb()->executeSQL('EXPLAIN SELECT COUNT(*) FROM '.self::tablename($table),[],self::MODE_SINGLE_ASSOC)['rows'];
	...
	public static function hastable($table)
	{
		...
		return self::query('SHOW TABLES LIKE "'.$table.'";',self::MODE_COLUMN_VALUE);
	}
	/**
	 * 获取当前数据库所有自定义函数
	 */
