;$(document).ready( function() {
    ...
    $('.lyear-layout-sidebar').delay(1).queue(function(){
        let elm = $('.nav-item-has-subnav.open');
        if(elm[0]){
            $('.lyear-layout-sidebar-info').animate({
                scrollTop:elm.index()*elm.height()
            }, 1000);
        }
    ...
    // 读取cookie中的主题设置
	var the_logo_bg    = localStorage.getItem('the_logo_bg'),
	    the_header_bg  = localStorage.getItem('the_header_bg'),
	    the_sidebar_bg = localStorage.getItem('the_sidebar_bg'),
	    the_site_theme = localStorage.getItem('the_site_theme');
	...
	setTheme = function(input_name, data_name) {
	    $("input[name='" + input_name + "']").click(function(){
	        ...
	        localStorage.setItem('the_'+input_name, check_theme);
	    });
	}
