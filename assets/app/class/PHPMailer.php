...
class PHPMailer
{
    ...
    {
        $myapp = \Nenge\APP::app();
        if(isset($myapp->language['mail_'.$key])):
            return $myapp->language['mail_'.$key];
        endif;
        if(isset($this->PHPMAILER_LANG[$key])):
            return $this->PHPMAILER_LANG[$key];
        endif;
        return $key;
    }
